        ...
        if records['type'] == "gene":
            ...
            if not records['attributes']['gene_id'] in gene_list:
                ...
                if 'description' in records['attributes']:
                    genome_buffer += "\t" + dcterms_ns + "description" + "\t" + " \"" + records['attributes']['description'] + "\" ;\n"
...
path_output = '/Users/pierre/workspace2015/datasets/test_Oryza_sativa.IRGSP-1.0.51.chromosome.1.gff3.ttl'
