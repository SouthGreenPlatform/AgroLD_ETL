...
# In here we buil the modele and writer in file with ttl format
    ...
    for records in msu_ds.as_matrix(columns=None):
        ...
        if not (records[0] == "None" or records[1] == "None"):
            ...
            os_japonica_buffer += "\t" + base_vocab_ns + "has_dbxref" + "\t" + tigr_g_ns + records[1].split('.')[
                0] + " ;\n"
...
path_output = '/Users/plarmande/Downloads/RAP-MSU_2018-03-29.ttl' # The output
...
ds = geneParser('/Users/plarmande/Downloads/RAP-MSU_2018-03-29.txt')
